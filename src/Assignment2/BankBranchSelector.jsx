...
const branches = {
  Bangalore: { address: 'chokkanahalli, Bangalore', code: 'BNG123', ifsc: 'BANK0001' },
  Mumbai: { address: 'tnagar,chennai', code: 'MUM456', ifsc: 'BANK0002' },
  Delhi: { address: 'india gate, Delhi', code: 'DEL789', ifsc: 'BANK0003' },
};
